...
Before we can continue to use the fitted model, we must check the model's assumptions. It is best to consider these according to the residual plot in Figure 8.
