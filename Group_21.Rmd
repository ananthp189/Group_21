...
```{r residplots,echo=FALSE, fig.width = 13, fig.align = "center",fig.cap = "\\label{fig:resids} Scatterplots of the residuals by Social,Freedom,corruption and a histogram of the residuals", fig.pos = 'H', message = FALSE}
