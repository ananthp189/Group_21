...
```{r boxplot, echo = FALSE, eval = TRUE, out.width = '90%', fig.pos = 'H', fig.align = "center", fig.cap = "\\label{fig:box} Boxplots of six variables."}
...
```{r radarplot, echo = FALSE, eval = TRUE, fig.pos = 'H', fig.align = "center", fig.cap = "\\label{fig:radar} Comparisons between Finland and the UK from six indexes."}
...
```{r map, echo = FALSE, eval = TRUE, fig.pos = 'H', fig.align = "center", fig.cap = "\\label{fig:map} World happiness score map."}
